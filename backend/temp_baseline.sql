...
CREATE TABLE `UserFavourites` (
    ...
    `productUnits` DOUBLE NULL,
    `unitsOfMeasurement` VARCHAR(50) NULL,
    `minOrderQuantity` INTEGER NULL DEFAULT 1,
    `addedAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),

    INDEX `IDX_user_favourites_user`(`customerId`),
    UNIQUE INDEX `UX_user_favourites_user_product`(`customerId`, `productId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Cart` (
    ...
    INDEX `IDX_cart_user`(`customerId`),
    UNIQUE INDEX `UX_cart_user_product`(`customerId`, `productId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ProductMaster` (
    ...
    `WholesalePrice` INTEGER NULL,
    `RetailPrice` INTEGER NULL,
    `MaxRetailPrice` INTEGER NULL,
    `Units` INTEGER NULL,
    `UnitsOfMeasurement` VARCHAR(50) NULL,
    ...
    `IsRetailProduct` INTEGER NULL,
    `Active` INTEGER NULL,
    `AddedUserID` VARCHAR(50) NULL,
    ...
    `OTSPrePR` INTEGER NULL,
    `OTSRegPR` INTEGER NULL,
    `Aliases` VARCHAR(50) NULL,
    `CategoryIDForApp` INTEGER NULL,
    `SubCategoryIDForApp` INTEGER NULL,
    `IsNewProduct` INTEGER NULL,
    `Parcelable` INTEGER NULL,
    `OfferEnabled` INTEGER NULL,
    `MinimumQty` INTEGER NULL,
    `DefaultLSQty` INTEGER NULL,
    `ProductInvIDForApp` INTEGER NULL,
    `CatalogID` INTEGER NULL,
    `CatalogDefault` INTEGER NULL,
    `SortOrder` INTEGER NULL,
    `PremiumPrice` INTEGER NULL,
    `UnitsForApp` INTEGER NULL,
    `UnitsOfMeasurementForApp` VARCHAR(50) NULL,
...
CREATE TABLE `DeliveryAddress` (
    `DeliveryAddressID` INTEGER NOT NULL AUTO_INCREMENT,
    `UserID` INTEGER NULL,
    ...
    `BuildingBlock` VARCHAR(100) NULL,
    `PinCode` VARCHAR(10) NULL,
    `Landmark` VARCHAR(200) NULL,
    `SaveAs` VARCHAR(20) NULL,
...
-- AddForeignKey
ALTER TABLE `UserFavourites` ADD CONSTRAINT `UserFavourites_customerId_fkey` FOREIGN KEY (`customerId`) REFERENCES `CUSTOMERMASTER`(`CUSTOMERID`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Cart` ADD CONSTRAINT `Cart_customerId_fkey` FOREIGN KEY (`customerId`) REFERENCES `CUSTOMERMASTER`(`CUSTOMERID`) ON DELETE RESTRICT ON UPDATE CASCADE;
